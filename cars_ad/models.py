...
class Cars(models.Model):
    ...
    img = models.CharField(max_length=500, default="thumbnail")
    picture = models.CharField(max_length=500, default="pic")
    picture1 = models.CharField(max_length=500, default="add extra pic")
